...
class TestShouldPauseForHuman:
    ...
    We patch TRANSACTION_HITL_ENABLED=True to test the real branching logic.
    """
    ...
    @patch("agents.transaction_agent.TRANSACTION_HITL_ENABLED", True)
    ...
    @patch("agents.transaction_agent.TRANSACTION_HITL_ENABLED", False)
    def test_hitl_disabled_never_pauses(self):
        """When TRANSACTION_HITL_ENABLED=False, nothing ever pauses."""
